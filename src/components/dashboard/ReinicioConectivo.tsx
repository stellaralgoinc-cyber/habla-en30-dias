...
interface ReinicioConectivoModalProps {
  open:         boolean;
...
export function ReinicioConectivoModal({ open, onOpenChange }: ReinicioConectivoModalProps) {
...
export function ReinicioConectivoButton() {
  ...
  return (
    <>
      ...
      <ReinicioConectivoModal open={open} onOpenChange={setOpen} />
    </>
  );
}
